#COMMON CONFIGURATION FILE FOR DATA PROCESSING PROGRAMS

try:
    import pandas as pd
    import os
except: 
    print("cant install pandas and os")
...
if IN_COLAB == False:
    ...
    # models
    lrc = '../results/lrc.sav'
    lrcUS = '../results/lrcUS.sav'
    MLP = '../results/MLP.h5'
    MLPUS = '../results/MLPUS.h5'
    rfc = '../results/rfc.sav'
    rfcUS = '../results/rfcUS.sav'
    ...
    # model results
    results = '../results/models_results.csv'
    ...
    #models
    lrc = path_to_module + 'results/lrc.sav'
    lrcUS = path_to_module + 'results/lrcUS.sav'
    MLP = path_to_module + 'results/MLP.h5'
    MLPUS = path_to_module + 'results/MLPUS.h5'
    rfc = path_to_module + 'results/rfc.sav'
    rfcUS = path_to_module + 'results/rfcUS.sav'
    ...
    #model results
    results = path_to_module +'results/models_results.csv'
    results_path = path_to_module +'results/'
...
def check_data_files_I():
    ...
    data_files = [weeklyDataWbook, dataWbook]
