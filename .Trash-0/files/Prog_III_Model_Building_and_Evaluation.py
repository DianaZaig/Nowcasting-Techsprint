...
import config
from config import check_model_results_file
from config import check_if_exist_or_create_folders
from config import check_data_files_III
...
#df_results = pd.read_excel(results, parse_dates=["date"])
df_results = pd.read_excel(config.results)
...
df_results.to_excel(config.results)
...
df_results_display = pd.read_excel(config.results)
...
df_results_display.groupby(['RF_Remarks'])['RF_Remarks','RFUS_ROC_Class1','RFUS_ROC_Class2','RFUS_ROC_Class3','RFUS_ROC_Class4','RFUS_ROC_Class5'].mean()
...
df_results_display.groupby(['HMLUS_Remarks'])['HMLUS_Remarks','HMLUS_Acc','HMLUS_Prec','HMLUS_F1','HMLUS_Recall','HMLUS_BA','HMLUS_CohensKappa','HMLUS_DP','HMLUS_GMEAN','HMLUS_NLiR','HMLUS_TypeIError','HMLUS_TypeIIError','HMLUS_YInd'].mean()
...
df_results_display.groupby(['HMLUS_Remarks'])['HMLUS_Remarks','HML_ROC_Class1','HML_ROC_Class2','HML_ROC_Class3','HML_ROC_Class4','HML_ROC_Class5'].mean()
...
df_results_display.groupby(['MLPUS_Remarks'])['MLPUS_Remarks','MLPUS_Acc','MLPUS_Prec','MLPUS_F1','MLPUS_Recall','MLPUS_BA','MLPUS_CohensKappa','MLPUS_DP','MLPUS_GMEAN','MLPUS_NLiR','MLPUS_TypeIError','MLPUS_TypeIIError','MLPUS_YInd'].mean()
...
df_results_display.groupby(['MLPUS_Remarks'])['MLPUS_Remarks', 'MLPUS_ROC_Class1', 'MLPUS_ROC_Class2', 'MLPUS_ROC_Class3', 'MLPUS_ROC_Class4', 'MLPUS_ROC_Class5'].mean()
