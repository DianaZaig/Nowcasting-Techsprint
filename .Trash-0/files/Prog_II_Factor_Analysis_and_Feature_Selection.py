...
from config import check_data_files_II
...
sns.heatmap(df_new.corr(),annot=True, vmin = 0.2, vmax=1, cmap="Greens", fmt='0.1')
...
plt.figure(figsize=(30,30))
sns.heatmap(df_new[df_new['INSTITUTIONCODE']=='B5015'].corr(),annot=True, vmin = 0.2, vmax=1, cmap="Greens", fmt='0.1')
...
sns.heatmap(df_new.corr(),annot=True, vmin = -1, vmax=-0.2, cmap="Greens", fmt='0.1')
...
dataset_corr_pearson=dataset.corr(method='pearson', min_periods=1)
dataset_corr_pearson = dataset_corr_pearson['MLA'].reset_index()
dataset_corr_pearson.rename(columns = {'MLA':'Pearson'}, inplace = True)
dataset_corr_spearman=dataset.corr(method='spearman', min_periods=1)
...
dataset_corr_kendall=dataset.corr(method='kendall', min_periods=1)
...
sns.heatmap(df_factors.corr(),annot=True, vmin = -1, vmax=-0.2, cmap="Greens", fmt='0.1')
